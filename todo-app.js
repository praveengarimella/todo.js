function Task(props) {
    return <li><input type = "checkbox"></input>{props.name}, {props.dueDate.toLocaleTimeString()},{props.due_date.toLocaleString()} <button onClick={() => {props.delete_item(props.task_id) }}>Delete</button>
    </li>
}
